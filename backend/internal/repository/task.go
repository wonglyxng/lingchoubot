...
func (r *TaskRepo) Create(ctx context.Context, t *model.Task) error {
	...
	return r.db.QueryRowContext(ctx, q,
		...
		t.Status, t.Priority, t.AssigneeID, t.ExecutionDomain, t.OwnerSupervisorID,
...
func (r *TaskRepo) Update(ctx context.Context, t *model.Task) error {
	const q = `
		...
		SET title = $2, description = $3, status = $4, priority = $5,
		    ...
		    execution_domain = $9, owner_supervisor_id = $10,
		    input_context = $11, output_summary = $12, metadata = $13, updated_at = now()
		WHERE id = $1
		RETURNING updated_at`
	return r.db.QueryRowContext(ctx, q,
		t.ID, t.Title, t.Description, t.Status, t.Priority,
		t.PhaseID, t.ParentTaskID, t.AssigneeID,
		t.ExecutionDomain, t.OwnerSupervisorID,
		t.InputContext, t.OutputSummary, t.Metadata,
	).Scan(&t.UpdatedAt)
}
