...
var promptVersions = map[string]PromptVersion{
	...
	"supervisor": {Role: "supervisor", Version: "1.1.0", ChangeLog: "保持契约产出结构，同时要求范围与验收标准面向真实交付"},
	"worker":     {Role: "worker", Version: "1.1.0", ChangeLog: "使用真实 artifact_type 枚举，强化分析任务与交付物类型绑定，禁止模板占位输出"},
	"reviewer":   {Role: "reviewer", Version: "1.2.0", ChangeLog: "要求输出单条任务级评审结论，禁止按工件拆分多条 review"},
}
